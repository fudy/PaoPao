var ReactComponents = ReactComponents || {}; ReactComponents["common"] =
...
/******/ 	__webpack_require__.p = "/javascripts/reactjs/build/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Captcha = React.createClass({
		...
		render: function () {
			return React.createElement('img', { src: this.state.src, alt: '正在获取验证码...', style: this.captchaStyle, onClick: this.changeCaptcha });
		}
	});

	module.exports.renderCaptcha = function (id, src) {
		ReactDOM.render(React.createElement(Captcha, { src: src }), document.getElementById(id));
	};
