...
var UserProtocal = React.createClass({
    getInitialState() {
            ...
            <span>
                ...
                <Modal show={this.state.showModal} onHide={this.close}>
                    <Modal.Header closeButton>
                        <Modal.Title>用户注册协议</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <p>
                            <h4>一、总则</h4>
                            1.1 跑跑测评的所有权和运营权归跑跑测评科技有限公司所有。 <br/>
                            1.2
                            用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与跑跑测评之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。
                            <br/>
                            1.3 本协议则可由跑跑测评随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。
                        </p>

                        <p>
                            <h4>二、服务内容</h4>
                            2.1 跑跑测评的具体内容由本站根据实际情况提供。 <br/>
                            2.2
                        ...
                        <p>
                            <h4>三、用户帐号</h4>
                            3.1
                            经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。跑跑测评有权对会员的权限设计进行变更。
                            <br/>
                            3.2
                        ...
                        <p><h4>六、版权声明</h4>
                            6.1 本站的文字、图片、音频、视频等版权均归跑跑测评有限公司享有或与作者共同享有，未经本站许可，不得任意转载。 <br/>
                            6.2 本站特有的标识、版面设计、编排方式等版权均属跑跑测评有限公司享有，未经本站许可，不得任意复制或转载。 <br/>
                            6.3 使用本站的任何内容均应注明“来源于跑跑测评”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。<br/>
                        ...
                        <p>
                            <h4>七、责任声明</h4>
                            7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，跑跑测评对此不承担任何责任。 <br/>
...
module.exports.UserProtocal = UserProtocal